...
class SQLiteStateStoreTests(unittest.TestCase):
    def test_state_store_round_trips_run_positions_and_trades(self) -> None:
        ...
        self.assertEqual(loaded_trades[0].round1_gross_bps, Decimal("3"))
        self.assertEqual(loaded_trades[0].round2_gross_bps, Decimal("3"))
        self.assertEqual(loaded_trades[0].round3_gross_bps, Decimal("5"))
        self.assertEqual(loaded_trades[0].round1_gross_pnl, Decimal("0.0003"))
        self.assertEqual(loaded_trades[0].round2_gross_pnl, Decimal("0.0003"))
        self.assertEqual(loaded_trades[0].round3_gross_pnl, Decimal("0.0005"))
